...
import com.shanhh.asr.assist.xfyun.config.LfasrProperties;
...
@Service
@Slf4j
public class LfasrClientImpl implements LfasrClient {
    ...
    public Message upload(File file, LfasrType type, Map<String, String> params) throws LfasrException {
        ...
        UploadWorker uw = new UploadWorker(signature, file, type, lfasrProperties.getFilePieceSize(), Maps.newHashMap(params));
        return uw.upload();
    }
    ...
    private Signature genSignature() throws SignatureException {
        return new Signature(lfasrProperties.getAppId(), lfasrProperties.getSecretKey());
    }
